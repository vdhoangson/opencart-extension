...
*******************************************************/
class ControllerPenBlogBlockTabCategory extends Controller {
	public function index($setting = array()){
		$languages = $this->language->load('penblog_block/tab_category');
		...
		return $this->load->view('penblog/block/tab_category.tpl', $data);
	}
}
?>