    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_login_to_download; ?></label>
            <div class="col-sm-10">
              <div class="btn-group" data-toggle="buttons">
                  <label class="btn <?php echo $login_to_download==1?'btn-primary active':'btn-default'; ?>">
                  <input type="radio" name="login_to_download" value="1" <?php echo $login_to_download==1?'checked':''; ?>><?php echo $text_on; ?></label>
                  <label class="btn <?php echo $login_to_download==0?'btn-primary active':'btn-default'; ?>">
                  <input type="radio" name="login_to_download" value="0" <?php echo $login_to_download==0?'checked':''; ?>><?php echo $text_off; ?></label>
               </div>
            </div>
          </div>
        </form>
