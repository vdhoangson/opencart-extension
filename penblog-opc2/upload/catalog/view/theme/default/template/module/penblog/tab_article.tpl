<div class="tab-set set-atab">
	...
	<?php if($articles){ ?>
		<?php foreach($articles as $article){ ?>
	  		<li><a data-toggle="tab" href="#article_<?php echo $article['article_id']; ?>"><?php echo $article['name']; ?></a></li>
		<?php } ?>
	<?php } ?>
	</ul>
	...
	<?php if($articles){ ?>
		<?php foreach($articles as $article){ ?>
		<div id="article_<?php echo $article['article_id']; ?>" class="tab-pane fade">
			<div class="row">
		          ...
		          <div class="product-thumb">
		            <div class="image">
		              ...
		              <?php } elseif($article['img_type']=='youtube') { ?>
		                 <iframe width="<?php echo $image_width; ?>" height="<?php echo $image_height; ?>" src="<?php echo $article['image']; ?>" style="border: none;"></iframe>
		              <?php } ?>
		            </div>
		            <div>
		              <div class="caption">
