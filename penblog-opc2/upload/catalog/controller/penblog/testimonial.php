...
class ControllerPenBlogTestimonial extends Controller {
	...
	public function index() {
		$languages = $this->load->language('penblog/testimonial');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('penblog/testimonial/success'));
		} 
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('penblog/testimonial')
		);
		...
		$data['action'] = $this->url->link('penblog/testimonial');
