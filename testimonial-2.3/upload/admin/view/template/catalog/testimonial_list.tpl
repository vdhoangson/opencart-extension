    ...
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-testimonial').submit() : false;"><i class="fa fa-trash-o"></i></button>
         <button data-toggle="tooltip" title="<?php echo $text_approval; ?>" class="btn btn-success" onclick="$('#form-testimonial').attr('action', '<?php echo $approval; ?>').submit()"><i class="fa fa-check"></i> <?php echo $text_approval; ?></button>
        <button data-toggle="tooltip" title="<?php echo $text_unapproval; ?>" class="btn btn-warning" onclick="$('#form-testimonial').attr('action', '<?php echo $unapproval; ?>').submit()"><i class="fa fa-close"></i> <?php echo $text_unapproval; ?></button>
      </div>
