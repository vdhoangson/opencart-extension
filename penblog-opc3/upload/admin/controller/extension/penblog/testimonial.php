...
class ControllerExtensionPenBlogTestimonial extends Controller {
	...
	public function index() {
		$this->load->language('extension/penblog/testimonial');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_penblog_testimonial->editTestimonial($this->request->get['testimonial_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $testimonial_id) {
				$this->model_extension_penblog_testimonial->deleteTestimonial($testimonial_id);
			}
	...
	protected function getList() {
		$language_data = $this->load->language('extension/penblog/testimonial');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('extension/penblog/testimonial/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/penblog/testimonial/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$testimonial_total = $this->model_extension_penblog_testimonial->getTotalTestimonials();

		$results = $this->model_extension_penblog_testimonial->getTestimonials($filter_data);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'icon' => 'fa fa-pencil',
				'href' => $this->url->link('extension/penblog/testimonial/edit', 'user_token=' . $this->session->data['user_token'] . '&testimonial_id=' . $result['testimonial_id'] . $url, true)
			);
		...
		$data['sort_customer'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=r.customer_name' . $url, true);
		$data['sort_service'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=r.service_id' . $url, true);
		$data['sort_read'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=r.read' . $url, true);
		$data['sort_rating'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=r.rating' . $url, true);
		$data['sort_status'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=r.status' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=r.date_added' . $url, true);
		...
		$pagination->url = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$template = 'extension/penblog/testimonial_list';
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['testimonial_id'])) {
			$data['action'] = $this->url->link('extension/penblog/testimonial/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/penblog/testimonial/edit', 'user_token=' . $this->session->data['user_token'] . '&testimonial_id=' . $this->request->get['testimonial_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/penblog/testimonial', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['testimonial_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$testimonial_info = $this->model_extension_penblog_testimonial->getTestimonial($this->request->get['testimonial_id']);
		}
		...
		$template = 'extension/penblog/testimonial_form';
		$this->response->setOutput($this->load->view($template, $data));

	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/penblog/testimonial')) {
