...
*******************************************************/
class ControllerExtensionPenBlogSearch extends Controller {
	public function index() {
		$languages = $this->language->load('extension/penblog/search');
		...
		if (isset($this->request->get['penblog_search']) || isset($this->request->get['tag']) || isset($this->request->get['date_added'])) {
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('extension/penblog/search', 'sort=p.sort_order&order=ASC' . $url)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_name_asc'),
				'value' => 'pd.name-ASC',
				'href'  => $this->url->link('extension/penblog/search', 'sort=pd.name&order=ASC' . $url)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_name_desc'),
				'value' => 'pd.name-DESC',
				'href'  => $this->url->link('extension/penblog/search', 'sort=pd.name&order=DESC' . $url)
			);
			...
			foreach($limits as $value) {
				$data['limits'][] = array(
					'text'  => $value,
					'value' => $value,
					'href'  => $this->url->link('extension/penblog/search', $url . '&limit=' . $value)
				);
			}
			...
			$pagination->url = $this->url->link('extension/penblog/search', $url . '&page={page}');
		...
		$template = 'extension/penblog/search';
